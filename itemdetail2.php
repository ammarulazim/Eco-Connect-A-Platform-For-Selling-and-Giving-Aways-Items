...
<main class="detail-wrapper">
    <div class="product-showcase-grid">
        ...
        <div class="showcase-left-stack">
            ...
            <?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $item['user_id'] && $report_count >= 5): ?>
            ...
            <div class="action-footer-cluster">
                ...
                <?php else: ?>
                    <div class="action-buttons-group">
                        ...
                        <a href="messaging_order.php?to_id=<?php echo $item['user_id']; ?>&item=<?php echo urlencode($item['item_name']); ?>" class="btn-checkout btn-buyer-contact">
